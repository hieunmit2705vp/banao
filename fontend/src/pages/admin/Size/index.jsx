...
export default function Size() {
    ...
    const fetchSizes = useCallback(async () => {
        try {
            ...
            toast.error("Đã xảy ra lỗi khi tải dữ liệu kích cỡ");
        }
    ...
    const handleToggleStatus = async (id) => {
        try {
            ...
            toast.success("Thay đổi trạng thái kích cỡ thành công!");
        } catch (error) {
            console.error("Error toggling size status:", error);
            toast.error("Không thể thay đổi trạng thái kích cỡ. Vui lòng thử lại!");
        }
    };
