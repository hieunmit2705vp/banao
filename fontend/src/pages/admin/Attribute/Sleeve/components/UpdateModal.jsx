...
const UpdateModal = ({ isOpen, setUpdateModal, sleeve, fetchSleeves }) => {
    ...
    const handleUpdate = async () => {
        ...
        try {
            await SleeveService.updateSleeve(sleeve.id, { id: sleeve.id, sleeveName: name }); // Fixed property names to match backend DTO
            ...
            <div className="text-center">
                ...
                <div className="mb-6 text-left">
                    <label className="block text-gray-700 text-sm font-bold mb-2 ml-1">
                        Sửa tên tay áo <span className="text-red-500">*</span>
                    </label>
                    <input
                        type="text"
